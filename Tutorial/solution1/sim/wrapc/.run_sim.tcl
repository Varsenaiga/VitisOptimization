...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cpp_FIR.autotvin.dat"
	set constFileTvOut       "cpp_FIR.autotvout.dat"
	set constFileHdlTvIn     "cpp_FIR.autohdltvin.dat"
	set constFileHdlTvOut    "cpp_FIR.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
