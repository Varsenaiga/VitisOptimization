...
entity master_fix_master_fix_Pipeline_Operations_Dense2_Loop6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    den2_V_0_1_out : OUT STD_LOGIC_VECTOR (35 downto 0);
    den2_V_0_1_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of master_fix_master_fix_Pipeline_Operations_Dense2_Loop6 is 
...
attribute shreg_extract : string;
    ...
    signal secondDense_f_V_1_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal secondDense_f_V_1_ce0 : STD_LOGIC;
    signal secondDense_f_V_1_q0 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal p_Result_3_fu_185_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln412_fu_203_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal num_V_3_fu_167_p4 : STD_LOGIC_VECTOR (35 downto 0);
    ...
    component master_fix_master_fix_Pipeline_Operations_Dense2_Loop6_secondDense_f_V_1 IS
    generic (
        DataWidth : INTEGER;
...
begin
    secondDense_f_V_1_U : component master_fix_master_fix_Pipeline_Operations_Dense2_Loop6_secondDense_f_V_1
    generic map (
        DataWidth => 19,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => secondDense_f_V_1_address0,
        ce0 => secondDense_f_V_1_ce0,
        q0 => secondDense_f_V_1_q0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                aux2_V_reg_262 <= secondDense_f_V_1_q0;
    ...
    add_ln310_fu_114_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv5_1));
    and_ln412_fu_203_p2 <= (p_Result_3_fu_185_p3 and or_ln412_fu_197_p2);
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_3_fu_58)
    begin
    ...
    den2_V_0_1_out <= lhs_fu_54;

    den2_V_0_1_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln310_reg_243_pp0_iter2_reg)
    begin
        if (((icmp_ln310_reg_243_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            den2_V_0_1_out_ap_vld <= ap_const_logic_1;
        else 
            den2_V_0_1_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    icmp_ln310_fu_108_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv5_10) else "0";
    lhs_3_fu_150_p3 <= (lhs_fu_54 & ap_const_lv19_0);
    num_V_3_fu_167_p4 <= ret_V_fu_161_p2(54 downto 19);
    num_V_fu_213_p2 <= std_logic_vector(unsigned(num_V_3_fu_167_p4) + unsigned(zext_ln415_fu_209_p1));
    or_ln412_fu_197_p2 <= (r_fu_192_p2 or p_Result_s_fu_177_p3);
    p_Result_3_fu_185_p3 <= r_V_reg_277(18 downto 18);
    p_Result_s_fu_177_p3 <= ret_V_fu_161_p2(19 downto 19);
    r_fu_192_p2 <= "0" when (trunc_ln727_reg_283 = ap_const_lv18_0) else "1";
    ret_V_fu_161_p2 <= std_logic_vector(unsigned(lhs_3_fu_150_p3) + unsigned(sext_ln1245_fu_158_p1));
    secondDense_f_V_1_address0 <= zext_ln315_fu_120_p1(4 - 1 downto 0);

    secondDense_f_V_1_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            secondDense_f_V_1_ce0 <= ap_const_logic_1;
        else 
            secondDense_f_V_1_ce0 <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln315_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
