...
module master_fix_master_fix_Pipeline_Operations_Dense2_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [35:0] den2_V_0_0_out;
output   den2_V_0_0_out_ap_vld;
...
reg    ap_ready_int;
wire   [3:0] secondDense_f_V_0_address0;
reg    secondDense_f_V_0_ce0;
wire   [18:0] secondDense_f_V_0_q0;
...
wire   [0:0] p_Result_4_fu_185_p3;
wire   [0:0] and_ln412_fu_203_p2;
wire   [35:0] num_V_5_fu_167_p4;
...
master_fix_master_fix_Pipeline_Operations_Dense2_Loop_secondDense_f_V_0 #(
    .DataWidth( 19 ),
    .AddressRange( 16 ),
    .AddressWidth( 4 ))
secondDense_f_V_0_U(
...
always @ (*) begin
    if (((icmp_ln310_reg_243_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        den2_V_0_0_out_ap_vld = 1'b1;
    end else begin
        den2_V_0_0_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        secondDense_f_V_0_ce0 = 1'b1;
    end else begin
        secondDense_f_V_0_ce0 = 1'b0;
    end
end
...
assign add_ln310_fu_114_p2 = (ap_sig_allocacmp_i + 5'd1);

assign and_ln412_fu_203_p2 = (p_Result_4_fu_185_p3 & or_ln412_fu_197_p2);
...
assign den2_V_0_0_out = lhs_fu_54;
...
assign icmp_ln310_fu_108_p2 = ((ap_sig_allocacmp_i == 5'd16) ? 1'b1 : 1'b0);

assign lhs_1_fu_150_p3 = {{lhs_fu_54}, {19'd0}};

assign num_V_5_fu_167_p4 = {{ret_V_fu_161_p2[54:19]}};

assign num_V_fu_213_p2 = (num_V_5_fu_167_p4 + zext_ln415_fu_209_p1);

assign or_ln412_fu_197_p2 = (r_fu_192_p2 | p_Result_s_fu_177_p3);

assign p_Result_4_fu_185_p3 = r_V_reg_277[32'd18];

assign p_Result_s_fu_177_p3 = ret_V_fu_161_p2[32'd19];

assign r_fu_192_p2 = ((trunc_ln727_reg_283 != 18'd0) ? 1'b1 : 1'b0);

assign ret_V_fu_161_p2 = ($signed(lhs_1_fu_150_p3) + $signed(sext_ln1245_fu_158_p1));

assign secondDense_f_V_0_address0 = zext_ln315_fu_120_p1;
...
assign zext_ln315_fu_120_p1 = ap_sig_allocacmp_i;

assign zext_ln415_fu_209_p1 = and_ln412_fu_203_p2;

endmodule //master_fix_master_fix_Pipeline_Operations_Dense2_Loop
