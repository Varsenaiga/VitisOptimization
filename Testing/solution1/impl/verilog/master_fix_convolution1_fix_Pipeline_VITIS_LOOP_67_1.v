...
module master_fix_convolution1_fix_Pipeline_VITIS_LOOP_67_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln67_reg_1633;
wire   [1:0] j_fu_420_p3;
reg   [1:0] j_reg_1637;
wire   [63:0] zext_ln72_1_fu_1059_p1;
wire    ap_block_pp0_stage0;
reg   [2:0] r_fu_116;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_r_3;
wire   [2:0] add_ln67_fu_402_p2;
...
wire   [11:0] select_ln71_8_fu_1204_p3;
reg   [11:0] tmp1_V_1_0_fu_176;
wire   [11:0] select_ln71_7_fu_1196_p3;
reg   [11:0] tmp1_V_2_0_fu_180;
wire   [11:0] select_ln71_5_fu_1180_p3;
reg   [11:0] tmp1_V_4_0_fu_184;
wire   [11:0] select_ln71_3_fu_1164_p3;
reg   [11:0] tmp1_V_5_0_fu_188;
wire   [11:0] select_ln71_1_fu_1148_p3;
...
wire   [15:0] select_ln69_fu_491_p3;
wire   [0:0] icmp_ln69_fu_428_p2;
wire    ap_block_pp0_stage0_01001;
wire   [1:0] empty_fu_392_p1;
wire   [0:0] icmp_ln68_fu_408_p2;
wire   [1:0] add_ln68_fu_414_p2;
wire  signed [15:0] sext_ln69_fu_437_p0;
wire  signed [15:0] trunc_ln69_fu_441_p0;
wire  signed [16:0] sext_ln69_fu_437_p1;
wire   [16:0] add_ln69_fu_445_p2;
wire   [6:0] trunc_ln69_fu_441_p1;
wire   [6:0] xor_ln69_fu_463_p2;
wire   [15:0] p_and_t_cast_fu_469_p3;
wire   [6:0] trunc_ln69_1_fu_459_p1;
wire   [0:0] tmp_fu_451_p3;
wire   [15:0] sub_ln69_fu_477_p2;
wire   [15:0] tmp_s_fu_483_p3;
wire   [3:0] zext_ln71_fu_537_p1;
wire   [3:0] add_ln72_fu_541_p2;
wire   [6:0] trunc_ln72_1_fu_1032_p1;
wire   [8:0] tmp_46_cast_fu_1036_p3;
wire   [8:0] trunc_ln72_fu_1028_p1;
wire   [8:0] sub_ln72_fu_1044_p2;
wire   [8:0] zext_ln72_fu_1050_p1;
wire   [8:0] add_ln72_1_fu_1053_p2;
wire   [0:0] icmp_ln71_4_fu_1117_p2;
wire   [0:0] icmp_ln71_3_fu_1112_p2;
wire   [0:0] icmp_ln71_2_fu_1107_p2;
wire   [0:0] icmp_ln71_1_fu_1102_p2;
wire   [0:0] icmp_ln71_fu_1097_p2;
wire   [0:0] or_ln71_fu_1122_p2;
wire   [0:0] or_ln71_1_fu_1128_p2;
wire   [0:0] or_ln71_2_fu_1142_p2;
wire   [11:0] select_ln71_fu_1134_p3;
wire   [11:0] select_ln71_2_fu_1156_p3;
wire   [11:0] select_ln71_4_fu_1172_p3;
wire   [11:0] select_ln71_6_fu_1188_p3;
wire   [11:0] tmp1_V_11_21_fu_1212_p1;
wire   [11:0] select_ln72_fu_1216_p3;
wire   [11:0] select_ln72_2_fu_1232_p3;
wire   [11:0] select_ln72_4_fu_1248_p3;
wire   [11:0] tmp1_V_11_17_fu_1264_p3;
wire   [11:0] select_ln72_8_fu_1280_p3;
wire   [11:0] select_ln72_9_fu_1288_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln67_fu_396_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln67_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln67_fu_396_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln67_fu_396_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln67_reg_1633 == 1'd1))) begin
...
assign add_ln67_fu_402_p2 = (ap_sig_allocacmp_r_3 + 3'd1);

assign add_ln68_fu_414_p2 = (empty_fu_392_p1 + 2'd1);

assign add_ln69_fu_445_p2 = ($signed(sext_ln69_fu_437_p1) + $signed(17'd1));

assign add_ln72_1_fu_1053_p2 = (sub_ln72_fu_1044_p2 + zext_ln72_fu_1050_p1);

assign add_ln72_fu_541_p2 = (zext_ln71_fu_537_p1 + 4'd6);
...
always @ (*) begin
    ap_condition_818 = ((icmp_ln67_fu_396_p2 == 1'd0) & (icmp_ln69_fu_428_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
assign icmp_ln67_fu_396_p2 = ((ap_sig_allocacmp_r_3 == 3'd6) ? 1'b1 : 1'b0);

assign icmp_ln68_fu_408_p2 = ((ap_sig_allocacmp_r_3 < 3'd3) ? 1'b1 : 1'b0);

assign icmp_ln69_fu_428_p2 = ((j_fu_420_p3 == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln71_1_fu_1102_p2 = ((r_3_reg_1624_pp0_iter1_reg == 3'd3) ? 1'b1 : 1'b0);

assign icmp_ln71_2_fu_1107_p2 = ((r_3_reg_1624_pp0_iter1_reg == 3'd2) ? 1'b1 : 1'b0);

assign icmp_ln71_3_fu_1112_p2 = ((r_3_reg_1624_pp0_iter1_reg == 3'd1) ? 1'b1 : 1'b0);

assign icmp_ln71_4_fu_1117_p2 = ((r_3_reg_1624_pp0_iter1_reg == 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln71_fu_1097_p2 = ((r_3_reg_1624_pp0_iter1_reg == 3'd4) ? 1'b1 : 1'b0);

assign input_r_address0 = zext_ln72_1_fu_1059_p1;

assign j_fu_420_p3 = ((icmp_ln68_fu_408_p2[0:0] == 1'b1) ? empty_fu_392_p1 : add_ln68_fu_414_p2);

assign or_ln71_1_fu_1128_p2 = (icmp_ln71_2_fu_1107_p2 | icmp_ln71_1_fu_1102_p2);

assign or_ln71_2_fu_1142_p2 = (or_ln71_fu_1122_p2 | or_ln71_1_fu_1128_p2);

assign or_ln71_fu_1122_p2 = (icmp_ln71_4_fu_1117_p2 | icmp_ln71_3_fu_1112_p2);

assign p_and_t_cast_fu_469_p3 = {{9'd0}, {xor_ln69_fu_463_p2}};

assign select_ln69_fu_491_p3 = ((tmp_fu_451_p3[0:0] == 1'b1) ? sub_ln69_fu_477_p2 : tmp_s_fu_483_p3);

assign select_ln71_1_fu_1148_p3 = ((or_ln71_2_fu_1142_p2[0:0] == 1'b1) ? tmp1_V_5_0_fu_188 : select_ln71_fu_1134_p3);

assign select_ln71_2_fu_1156_p3 = ((icmp_ln71_fu_1097_p2[0:0] == 1'b1) ? 12'd4089 : tmp1_V_4_0_fu_184);

assign select_ln71_3_fu_1164_p3 = ((or_ln71_2_fu_1142_p2[0:0] == 1'b1) ? tmp1_V_4_0_fu_184 : select_ln71_2_fu_1156_p3);

assign select_ln71_4_fu_1172_p3 = ((icmp_ln71_2_fu_1107_p2[0:0] == 1'b1) ? 12'd4089 : tmp1_V_2_0_fu_180);

assign select_ln71_5_fu_1180_p3 = ((or_ln71_fu_1122_p2[0:0] == 1'b1) ? tmp1_V_2_0_fu_180 : select_ln71_4_fu_1172_p3);

assign select_ln71_6_fu_1188_p3 = ((icmp_ln71_3_fu_1112_p2[0:0] == 1'b1) ? 12'd4089 : tmp1_V_1_0_fu_176);

assign select_ln71_7_fu_1196_p3 = ((icmp_ln71_4_fu_1117_p2[0:0] == 1'b1) ? tmp1_V_1_0_fu_176 : select_ln71_6_fu_1188_p3);

assign select_ln71_8_fu_1204_p3 = ((icmp_ln71_4_fu_1117_p2[0:0] == 1'b1) ? 12'd4089 : tmp1_V_0_0_fu_172);

assign select_ln71_fu_1134_p3 = ((icmp_ln71_fu_1097_p2[0:0] == 1'b1) ? tmp1_V_5_0_fu_188 : 12'd4089);

assign select_ln72_2_fu_1232_p3 = ((icmp_ln71_fu_1097_p2[0:0] == 1'b1) ? tmp1_V_11_21_fu_1212_p1 : tmp1_V_11_11_fu_200);

assign select_ln72_4_fu_1248_p3 = ((icmp_ln71_2_fu_1107_p2[0:0] == 1'b1) ? tmp1_V_11_21_fu_1212_p1 : tmp1_V_11_4_fu_196);

assign select_ln72_8_fu_1280_p3 = ((icmp_ln71_2_fu_1107_p2[0:0] == 1'b1) ? tmp1_V_11_9_fu_168 : tmp1_V_11_21_fu_1212_p1);

assign select_ln72_9_fu_1288_p3 = ((or_ln71_fu_1122_p2[0:0] == 1'b1) ? tmp1_V_11_9_fu_168 : select_ln72_8_fu_1280_p3);

assign select_ln72_fu_1216_p3 = ((icmp_ln71_fu_1097_p2[0:0] == 1'b1) ? tmp1_V_11_13_fu_204 : tmp1_V_11_21_fu_1212_p1);

assign sext_ln69_fu_437_p0 = ap_sig_allocacmp_i_load;

assign sext_ln69_fu_437_p1 = sext_ln69_fu_437_p0;

assign sub_ln69_fu_477_p2 = (16'd0 - p_and_t_cast_fu_469_p3);

assign sub_ln72_fu_1044_p2 = (tmp_46_cast_fu_1036_p3 - trunc_ln72_fu_1028_p1);
...
assign tmp1_V_11_15_fu_1240_p3 = ((or_ln71_2_fu_1142_p2[0:0] == 1'b1) ? tmp1_V_11_11_fu_200 : select_ln72_2_fu_1232_p3);

assign tmp1_V_11_16_fu_1256_p3 = ((or_ln71_fu_1122_p2[0:0] == 1'b1) ? tmp1_V_11_4_fu_196 : select_ln72_4_fu_1248_p3);

assign tmp1_V_11_17_fu_1264_p3 = ((icmp_ln71_3_fu_1112_p2[0:0] == 1'b1) ? tmp1_V_11_21_fu_1212_p1 : tmp1_V_11_6_fu_192);

assign tmp1_V_11_18_fu_1272_p3 = ((icmp_ln71_4_fu_1117_p2[0:0] == 1'b1) ? tmp1_V_11_6_fu_192 : tmp1_V_11_17_fu_1264_p3);

assign tmp1_V_11_19_fu_1296_p3 = ((or_ln71_2_fu_1142_p2[0:0] == 1'b1) ? select_ln72_9_fu_1288_p3 : tmp1_V_11_9_fu_168);

assign tmp1_V_11_20_fu_1304_p3 = ((icmp_ln71_4_fu_1117_p2[0:0] == 1'b1) ? tmp1_V_11_21_fu_1212_p1 : tmp1_V_11_2_fu_164);
...
assign tmp1_V_11_fu_1224_p3 = ((or_ln71_2_fu_1142_p2[0:0] == 1'b1) ? tmp1_V_11_13_fu_204 : select_ln72_fu_1216_p3);
...
assign tmp_46_cast_fu_1036_p3 = {{trunc_ln72_1_fu_1032_p1}, {2'd0}};

assign tmp_fu_451_p3 = add_ln69_fu_445_p2[32'd16];

assign tmp_s_fu_483_p3 = {{9'd0}, {trunc_ln69_1_fu_459_p1}};

assign trunc_ln69_1_fu_459_p1 = add_ln69_fu_445_p2[6:0];

assign trunc_ln69_fu_441_p0 = ap_sig_allocacmp_i_load;

assign trunc_ln69_fu_441_p1 = trunc_ln69_fu_441_p0[6:0];

assign trunc_ln72_1_fu_1032_p1 = i_fu_208[6:0];

assign trunc_ln72_fu_1028_p1 = i_fu_208[8:0];

assign xor_ln69_fu_463_p2 = (trunc_ln69_fu_441_p1 ^ 7'd127);

assign zext_ln71_fu_537_p1 = ap_sig_allocacmp_r_3;

assign zext_ln72_1_fu_1059_p1 = add_ln72_1_fu_1053_p2;

assign zext_ln72_fu_1050_p1 = j_reg_1637;

endmodule //master_fix_convolution1_fix_Pipeline_VITIS_LOOP_67_1
