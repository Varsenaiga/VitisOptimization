...
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start;
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_done;
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_idle;
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_ready;
wire   [3:0] grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_address0;
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_ce0;
wire    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_we0;
wire   [34:0] grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_d0;
reg    grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 114'd1;
#0 grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg = 1'b0;
end

master_fix_dense1_fix_Pipeline_VITIS_LOOP_255_1 grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start),
    .ap_done(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_done),
    .ap_idle(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_idle),
    .ap_ready(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_ready),
    ...
    .out_0_address0(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_address0),
    .out_0_ce0(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_ce0),
    .out_0_we0(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_we0),
    .out_0_d0(grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_d0)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state113)) begin
            grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg <= 1'b1;
        end else if ((grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_ready == 1'b1)) begin
            grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state114) & (grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_done == 1'b1)) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state114) & (grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_done == 1'b1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start = grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_ap_start_reg;

assign out_0_address0 = grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_address0;

assign out_0_ce0 = grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_ce0;

assign out_0_d0 = grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_d0;

assign out_0_we0 = grp_dense1_fix_Pipeline_VITIS_LOOP_255_1_fu_2929_out_0_we0;
