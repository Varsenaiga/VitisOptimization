...
if {[file isfile master_fix.autotvin.dat]} {
	file delete -force master_fix.autotvin.dat
}

if {[file isfile master_fix.autotvout.dat]} {
	file delete -force master_fix.autotvout.dat
}
