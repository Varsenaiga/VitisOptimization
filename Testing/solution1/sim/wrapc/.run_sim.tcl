...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "master_fix.autotvin.dat"
	set constFileTvOut       "master_fix.autotvout.dat"
	set constFileHdlTvIn     "master_fix.autohdltvin.dat"
	set constFileHdlTvOut    "master_fix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
