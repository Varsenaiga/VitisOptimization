...
entity master_fix_master_fix_Pipeline_VITIS_LOOP_498_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of master_fix_master_fix_Pipeline_VITIS_LOOP_498_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln498_fu_188_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln498_reg_669 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln498_reg_669_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln498_reg_669_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln498_fu_194_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_6_fu_268_p3 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal icmp_ln499_fu_515_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln499_1_fu_527_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal m_3_39_fu_520_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln499_2_fu_540_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    mux_42_36_1_1_U299 : component master_fix_mux_42_36_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 36,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln498_fu_188_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_108 <= add_ln498_fu_194_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln498_reg_669 <= icmp_ln498_fu_188_p2;
                icmp_ln498_reg_669_pp0_iter1_reg <= icmp_ln498_reg_669;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                icmp_ln498_reg_669_pp0_iter2_reg <= icmp_ln498_reg_669_pp0_iter1_reg;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln498_fu_188_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln498_fu_194_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv3_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln498_fu_188_p2)
    begin
        if (((icmp_ln498_fu_188_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln498_fu_188_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv3_4) else "0";
    icmp_ln499_1_fu_527_p2 <= "1" when (trunc_ln938_reg_673_pp0_iter3_reg = ap_const_lv2_1) else "0";
    icmp_ln499_2_fu_540_p2 <= "1" when (trunc_ln938_reg_673_pp0_iter3_reg = ap_const_lv2_0) else "0";
    icmp_ln499_fu_515_p2 <= "1" when (trunc_ln938_reg_673_pp0_iter3_reg = ap_const_lv2_2) else "0";
    ...
    l_fu_276_p1 <= tmp_6_fu_268_p3(32 - 1 downto 0);
    ...
    m_2_03_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln498_reg_669_pp0_iter2_reg)
    begin
        if (((icmp_ln498_reg_669_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_3_04_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln498_reg_669_pp0_iter2_reg)
    begin
        if (((icmp_ln498_reg_669_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_3_10_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln498_reg_669_pp0_iter2_reg)
    begin
        if (((icmp_ln498_reg_669_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_3_13_fu_532_p3 <= 
        m_3_04_fu_124 when (icmp_ln499_1_fu_527_p2(0) = '1') else 
        m_3_39_fu_520_p3;
    m_3_14_fu_545_p3 <= 
        m_3_04_fu_124 when (icmp_ln499_2_fu_540_p2(0) = '1') else 
        m_3_13_fu_532_p3;
    m_3_15_fu_553_p3 <= 
        m_3_21_reg_740 when (icmp_ln499_fu_515_p2(0) = '1') else 
        m_3_10_fu_120;
    m_3_16_fu_560_p3 <= 
        m_3_10_fu_120 when (icmp_ln499_1_fu_527_p2(0) = '1') else 
        m_3_15_fu_553_p3;
    m_3_17_fu_568_p3 <= 
        m_3_10_fu_120 when (icmp_ln499_2_fu_540_p2(0) = '1') else 
        m_3_16_fu_560_p3;
    m_3_18_fu_576_p3 <= 
        m_3_21_reg_740 when (icmp_ln499_1_fu_527_p2(0) = '1') else 
        m_3_7_fu_116;
    m_3_19_fu_583_p3 <= 
        m_3_7_fu_116 when (icmp_ln499_2_fu_540_p2(0) = '1') else 
        m_3_18_fu_576_p3;
    m_3_20_fu_591_p3 <= 
        m_3_21_reg_740 when (icmp_ln499_2_fu_540_p2(0) = '1') else 
        m_3_1_fu_112;
    m_3_21_fu_496_p3 <= 
        ap_const_lv64_0 when (icmp_ln938_reg_680_pp0_iter2_reg(0) = '1') else 
        bitcast_ln741_fu_492_p1;
    m_3_39_fu_520_p3 <= 
        m_3_04_fu_124 when (icmp_ln499_fu_515_p2(0) = '1') else 
        m_3_21_reg_740;
    m_3_7_out <= m_3_7_fu_116;

    m_3_7_out_ap_vld_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln498_reg_669_pp0_iter2_reg)
    begin
        if (((icmp_ln498_reg_669_pp0_iter2_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    tmp_6_fu_268_p3_proc : process(p_Result_7_fu_261_p3)
    begin
        tmp_6_fu_268_p3 <= std_logic_vector(to_unsigned(64, 64));
        for i in 0 to 64 - 1 loop
            if p_Result_7_fu_261_p3(i) = '1' then
                tmp_6_fu_268_p3 <= std_logic_vector(to_unsigned(i,64));
                exit;
            end if;
        end loop;
    end process;
    ...
    trunc_ln946_fu_339_p1 <= tmp_6_fu_268_p3(11 - 1 downto 0);
