...
// ==============================================================
#ifndef __master_fix_thirdBias_f_V_H__
#define __master_fix_thirdBias_f_V_H__
...
struct master_fix_thirdBias_f_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(master_fix_thirdBias_f_V_ram) {
...
SC_MODULE(master_fix_thirdBias_f_V) {
...
master_fix_thirdBias_f_V_ram* meminst;


SC_CTOR(master_fix_thirdBias_f_V) {
meminst = new master_fix_thirdBias_f_V_ram("master_fix_thirdBias_f_V_ram");
