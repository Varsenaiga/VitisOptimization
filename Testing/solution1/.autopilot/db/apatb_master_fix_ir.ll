...
%struct.ssdm_int = type { i12 }

; Function Attrs: noinline
define void @apatb_master_fix_ir([3 x %struct.ap_fixed]* %input, [4 x float]* %out) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([128 x [3 x %struct.ap_fixed]]* %0, [128 x [3 x i12]]* nonnull align 512 %input_copy, [1 x [4 x float]]* %1, [1 x [4 x float]]* nonnull align 512 %out_copy)
  ...
  call fastcc void @copy_out([128 x [3 x %struct.ap_fixed]]* %0, [128 x [3 x i12]]* nonnull align 512 %input_copy, [1 x [4 x float]]* %1, [1 x [4 x float]]* nonnull align 512 %out_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in([128 x [3 x %struct.ap_fixed]]* readonly, [128 x [3 x i12]]* noalias align 512, [1 x [4 x float]]* readonly, [1 x [4 x float]]* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a128a3struct.ap_fixed([128 x [3 x i12]]* align 512 %1, [128 x [3 x %struct.ap_fixed]]* %0)
  call fastcc void @onebyonecpy_hls.p0a1a4f32([1 x [4 x float]]* align 512 %3, [1 x [4 x float]]* %2)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a128a3struct.ap_fixed([128 x [3 x i12]]* noalias align 512, [128 x [3 x %struct.ap_fixed]]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([128 x [3 x %struct.ap_fixed]]*, [128 x [3 x i12]]* noalias readonly align 512, [1 x [4 x float]]*, [1 x [4 x float]]* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a128a3struct.ap_fixed.84([128 x [3 x %struct.ap_fixed]]* %0, [128 x [3 x i12]]* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a1a4f32([1 x [4 x float]]* %2, [1 x [4 x float]]* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a128a3struct.ap_fixed.84([128 x [3 x %struct.ap_fixed]]* noalias, [128 x [3 x i12]]* noalias readonly align 512) unnamed_addr #2 {
entry:
...
entry:
  ...
  call void @copy_out([128 x [3 x %struct.ap_fixed]]* %2, [128 x [3 x i12]]* %3, [1 x [4 x float]]* null, [1 x [4 x float]]* %4)
  %5 = bitcast [128 x [3 x %struct.ap_fixed]]* %2 to [3 x %struct.ap_fixed]*
  %6 = bitcast [1 x [4 x float]]* %4 to [4 x float]*
  call void @master_fix_hw_stub([3 x %struct.ap_fixed]* %5, [4 x float]* %6)
  call void @copy_in([128 x [3 x %struct.ap_fixed]]* %2, [128 x [3 x i12]]* %3, [1 x [4 x float]]* null, [1 x [4 x float]]* %4)
  ret void
}

declare void @master_fix_hw_stub([3 x %struct.ap_fixed]*, [4 x float]*)
