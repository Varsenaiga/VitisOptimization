...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_r_address0", 9, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("input_r_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("input_r_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("input_r_address1", 9, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	...
	Port_Property("out_r_address0", 2, hls_out, 1, "ap_memory", "mem_address", 1),
...
const char* HLS_Design_Meta::dut_name = "master_fix";
