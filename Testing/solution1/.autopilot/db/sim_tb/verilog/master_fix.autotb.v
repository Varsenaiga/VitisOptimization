...
`define AUTOTB_DUT      master_fix
`define AUTOTB_DUT_INST AESL_inst_master_fix
`define AUTOTB_TOP      apatb_master_fix_top
`define AUTOTB_LAT_RESULT_FILE "master_fix.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "master_fix.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_master_fix_top
...
`define AUTOTB_TVIN_input_r  "./c.master_fix.autotvin_input_r.dat"
`define AUTOTB_TVIN_out_r  "./c.master_fix.autotvin_out_r.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "./rtl.master_fix.autotvin_input_r.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.master_fix.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.master_fix.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.master_fix.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 111198;
parameter LENGTH_input_r = 384;
parameter LENGTH_out_r = 4;
...
wire    [8 : 0]    arrayinput_r_address0, arrayinput_r_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.master_fix.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.master_fix.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.master_fix.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.master_fix.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.master_fix.autotvout_out_r.dat with impl_rtl.master_fix.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
